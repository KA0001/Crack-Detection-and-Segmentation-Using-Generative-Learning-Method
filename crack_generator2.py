...
for i in bgs:
    ...
    crack.fill(255)
    cv2.polylines(crack, np.int32([points]), isClosed=False, color=(0, 0, 0), thickness=2)
    ...
    cv2.imwrite('generated_data/res2/img/' + basename, dst)
    cv2.imwrite('generated_data/res2/msk/' + basename, crack)
